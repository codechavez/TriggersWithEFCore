    ...
    public class TriggersEFCoreContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserBirthday>(e =>
            {
                ...
                e.Property(c => c.UserId).HasColumnName("UserBirthdayId").HasColumnType("bigint").ValueGeneratedOnAdd();
                e.Property(c => c.Email).HasColumnName("UserBirthdayId").HasColumnType("bigint").ValueGeneratedOnAdd();
                e.Property(c => c.Birthday).HasColumnName("UserBirthdayId").HasColumnType("bigint").ValueGeneratedOnAdd();
            });
        }
    }
}
